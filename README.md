...
```
cd existing_repo
git remote add origin https://gitlab.aspiritech.org/aspiritech/automation-team/aspiritechcypress.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.aspiritech.org/aspiritech/automation-team/aspiritechcypress/-/settings/integrations)
