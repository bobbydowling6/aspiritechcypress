describe('template spec', () => {
    beforeEach(() => {
        ...
        cy.get('.elementor-element-4547bec > .elementor-widget-container > .elementor-heading-title').contains('News & Resources').should('be.visible')
            })
    it('passes', () => {
        cy.section('Selecting the First 2 Articles')
        cy.get('.elementor-element-e99555d > .elementor-widget-container > .elementor-heading-title').contains('Recent Posts').should('be.visible')
        ...
        cy.get('[href="https://aspiritech.org/aspiritech-news-resources/2/"]').contains('2').click()
        cy.title().should('eq', 'News & Resources – Page 2 – Aspiritech')
        cy.get('.current').url().should('include', '2')
        cy.get('[href="https://aspiritech.org/aspiritech-news-resources/3/"]').contains('3').click()
        cy.title().should('eq', 'News & Resources – Page 3 – Aspiritech')
        cy.get('.current').url().should('include', '3')
        cy.get('[href="https://aspiritech.org/aspiritech-news-resources/4/"]').contains('4').click()
        cy.title().should('eq', 'News & Resources – Page 4 – Aspiritech')
        cy.get('.current').url().should('include', '4')
        cy.get('[href="https://aspiritech.org/aspiritech-news-resources/5/"]').contains('5').click()
        cy.title().should('eq', 'News & Resources – Page 5 – Aspiritech')
        cy.get('.current').url().should('include', '5')

        cy.section('More Topics & Categories')
        cy.get('.elementor-element-68ba64e > .elementor-widget-container > .elementor-heading-title').contains('More Topics & Categories').should('be.visible')
