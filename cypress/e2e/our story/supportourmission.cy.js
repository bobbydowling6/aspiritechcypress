describe('template spec', () => {
    beforeEach(() => {
        ...
        cy.get('.elementor-element-dc14c61 > .elementor-widget-container > .elementor-button-wrapper > .elementor-button').contains('Shop Now')
        cy.get('.elementor-element-05c4af7 > .elementor-widget-container > p').contains('Create a Lasting Legacy').should('be.visible')
        cy.get('.elementor-element-ce25fe6 > .elementor-widget-container > .elementor-button-wrapper > .elementor-button').contains('Donor Confidentiality and Privacy Policy')
        cy.get('.elementor-element-93b4d58 > .elementor-widget-container > h2').contains('Support Aspiritech!')
        cy.get('[href="https://www.givelively.org/terms"] > span').contains('Terms')
        cy.get('[href="https://www.givelively.org/privacy"] > span').contains('Privacy')
        })
    it('passes', () => {
