describe('template spec', () => {
    ...
    it('passes', () => {
        cy.get('.elementor-element-75544df > .elementor-widget-container > h2').contains('Employment opportunities at Aspiritech').should('be.visible')
        cy.get('.elementor-element-c9d1246 > .elementor-widget-container > .elementor-button-wrapper > .elementor-button').contains('Apply now').click()
        ...
        cy.get('.elementor-element-bd6a80d > .elementor-container > .elementor-column > .elementor-widget-wrap > .elementor-element > .elementor-widget-container > h2').contains('Aspiritech Careers: FAQ').should('be.visible')
        ...
        cy.get('.elementor-element-5e2e8ff > .elementor-widget-wrap > .elementor-element > .elementor-widget-container > h2').contains('Social Programs').should('be.visible')
