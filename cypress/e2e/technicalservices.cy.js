describe('template spec', () => {
    ...
    it('passes', () => {
        ...
        cy.get('.elementor-element-68c0fc70 > .elementor-widget-container > .elementor-heading-title').contains('Audio Testing').should('be.visible')
        ...
        cy.get('.elementor-element-fce111c > .elementor-widget-container > .elementor-heading-title').contains('Aon Accessibility Case Study').should('be.visible')
        ...
        cy.go('back')
        cy.get('.post-4392 > .elementor-post__card > .elementor-post__text > .elementor-post__title').contains('Astellas Case Study').click()
        cy.get('.elementor-element-18968701 > .elementor-widget-container > .elementor-heading-title').contains('Astellas QA & Product Excellence Case Study').should('be.visible')
        cy.url().should('include', 'astellas-case-study')
        cy.go('back')
        ...
        cy.go('back')
        cy.get('.post-4380 > .elementor-post__card > .elementor-post__text > .elementor-post__title').contains('Otus Case Study').click()
        cy.get('.elementor-element-2316f4b7 > .elementor-widget-container > .elementor-heading-title').contains('Otus QA & Product Excellence Case Study').should('be.visible')
